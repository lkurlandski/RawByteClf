...
for n_layer, d_model, params in CONFIGS:
    ...
    jobname = f"clf_None_{n_layer}-{d_model}"

    root = Path(f"/home/lk3591/Documents/code/RawByteClf/output/scaling/mamba/512/clm/1/d_model--{d_model}/n_layer--{n_layer}/mlp_hidden_size--512")
    ...
    pretrained_model_path = pretrained_model_path / "checkpoint-1400"
