...
#SBATCH --job-name=mamba_ftclf_512
...
--max_grad_norm=1.0 \
--save_total_limit=3 \
--model_name_or_path="/home/lk3591/Documents/code/RawByteClf/output/mamba/512/clm/1/d_model--512/n_layer--2/mlp_hidden_size--512/per_device_train_batch_size--1024/gradient_accumulation_steps--4/learning_rate--0.0001/weight_decay--0.05/adam_beta1--0.9/adam_beta2--0.98/adam_epsilon--1e-08/max_grad_norm--0.5/lr_scheduler_type--linear/warmup_ratio--0.05/bf16--False/fp16--True/tf32--True/optim--adamw_torch/checkpoints/checkpoint-4660" \
--max_length=512 \
